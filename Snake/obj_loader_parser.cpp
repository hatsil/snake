...
glm::vec2 snake::OBJModel::ParseOBJVec2(const std::string& line) {
...
glm::vec3 snake::OBJModel::ParseOBJVec3(const std::string& line) {
	uint tokenLength = line.length();
	const char* tokenString = line.c_str();
...
snake::OBJIndex snake::OBJModel::ParseOBJIndex(const std::string& token) {
...
void snake::OBJModel::CreateOBJFace(const std::string& line, std::set<Triangle>& trianglesSet) {
